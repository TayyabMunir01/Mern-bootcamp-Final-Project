...
async function addCourse(id,userInfo){
    let res = await Course.create({courseInfo:{courseName: userInfo.courseName,courseCode: userInfo.courseCode,creditHours: userInfo.creditHours}, teacher: new mongoose.Types.ObjectId(id) })
